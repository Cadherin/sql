...
```
I can think of many systems that support the functioning of our society and touch different aspects of our lives. To name a few, from a financial perspective – credit scoring and loan approval algorithms, from a career perspective – resume screening systems; from an insurance perspective – health, auto, home insurance risk scoring; from a welfare and benefits perspective – systems and rules that govern eligibility. All of these systems embed in them concepts of fairness, inequality, social structures and marginalization that necessitate careful design considerations to ensure they evolve with changing conditions over time. 

Take credit approval systems for example, there is a complex set of considerations a creditor would consider when reviewing a loan application. These considerations would tie to different facets of an applicant’s life. However, some of these criteria may put certain groups of individuals at a disadvantage because of normative rules that remain ingrained into the decision-making process. For example, the basic requirement may include being the age of majority of the province or territory of residence and be a citizen or resident. For one, the former is not entirely the same across all provinces (i.e. the age of majority in all provinces of Canada is 18 except for BC, NB, NU, NL, NS, which is 19). In terms of resident status or citizenship, some individuals may be affluent but would be declined a loan because they simply have not yet met the minimum citizenship or resident requirement. If the government is to amend any of these rules, the systems need to be agile to adapt to the changes that tie status related elements. 

Separately, many organizations and government agencies today still work with disparate systems that maintain the same or similar personally identifiable information that perhaps do not synchronized. For instance, a legal name change that occurs at a township or city level and may not automatically synchronize with the provincial or federal systems necessarily. Citizens often need to verify if additional processes are required to ensure changes are made across other identity issuers. Not updating them across the board may impact processes governed by the different issuers down the road that may not be uncovered until the citizen finds that need for those services. And these may very well be welfare or benefits related processes that arise only in certain stages or milestones of a person’s life that may not occur until years later. An example would be retirement and when its time to claim the related benefits.
The perspective above demonstrates that system design should not remain static. It must evolve to be adaptive and intelligent, ensuring equitable treatment for all users. As systems are intended to enhance efficiency and simplify processes, they ought to also possess the ability to identify shortcomings proactively rather than requiring users, who may lack technical knowledge to exert unnecessary efforts to accommodate systems’ limitations.
```
